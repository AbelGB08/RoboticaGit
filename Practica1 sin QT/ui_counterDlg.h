...
public:
    ...
    void retranslateUi(QWidget *Counter)
    {
        ...
        button->setText(QApplication::translate("Counter", "STOP", Q_NULLPTR));
        pushButton->setText(QApplication::translate("Counter", "INCREASE", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("Counter", "DECREASE", Q_NULLPTR));
    } // retranslateUi
